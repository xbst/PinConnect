...
The command-line generator for PinConnect. It reads a board TOML config and produces a single self-contained interactive HTML pinout — an SVG overlay of connectors and pin lines on top of your board image.
