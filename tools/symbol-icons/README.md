...
Exports each built-in connector symbol as a standalone SVG into `assets/symbols/`, so the [board TOML reference](../../docs/reference/board-toml.md#symbol) can show the icons in its symbol table.
